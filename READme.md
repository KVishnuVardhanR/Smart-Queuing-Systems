...
and directing people to less congested queue. These type of systems are used in **Retail** for Retail analytics, **Manufacturing/Production** to understand increase or  decrease in production rate and **Transportation** to direct passengers to less congested areas and also in areas like Mining and so on. And before deploying these systems 
